...
def test_obvious():
    ...
    b = "/ˈɑːbviəs/"
    r = english_gana(a, b)
    assert r == "[o|ŏ]bv[i|ï][o][u|ú]s"
...
def test_anxious():
    ...
    b = "/ˈæŋkʃəs/"
    r = english_gana(a, b)
    assert r == "[a|ă]n[xi|ksh][o][u|ú]s"
...
def test_anxiety():
    ...
    b = "/æŋˈzaɪəti/"
    r = english_gana(a, b)
    assert r == "[a|ă][n|ng]ˈ[x|z][i|ī][e|é]ty"
